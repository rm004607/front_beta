...
export const chileData: Region[] = [
    ...
    },
    {
        ...
        communes: ["Concepción", "Coronel", "Chiguayante", "Florida", "Hualquén", "Lota", "Penco", "San Pedro de la Paz", "Santa Juana", "Talcahuano", "Tomé", "Hualpén", "Lebu", "Arauco", "Cañete", "Contulmo", "Curanilahue", "Los Álamos", "Tirúa", "Los Ángeles", "Antuco", "Cabrero", "Laja", "Mulchén", "Nacimiento", "Negrete", "Quilaco", "Quilleco", "San Rosendo", "Santa Bárbara", "Tucapel", "Yumbel", "Alto Biobío"]
    },
    {
        id: "9",
    ...
    {
        id: "11",
        name: "Región Aysén del Gral. Carlos Ibáñez del Campo",
